      ...
      <div className="grid gap-5 xl:grid-cols-[0.95fr_1.05fr]">
        <Panel>
          ...
          <div className="rounded-[28px] bg-white p-4 shadow-sm">
            ...
            <Link href="/tenet/portal/requests" className="mt-4 flex w-full items-center justify-center rounded-2xl bg-[#151612] px-4 py-3 text-sm font-bold text-white">
              Submit request
            </Link>
          </div>
        </Panel>
        ...
        <Panel>
          ...
          <div className="space-y-3">
            {tenantDocuments.slice(0, 3).map((document) => (
              <Link key={document.title} href="/tenet/portal/documents" className="flex items-center gap-3 rounded-[24px] bg-[#f7f3ea] p-4">
                <FileText size={18} />
                <div className="min-w-0 flex-1">
